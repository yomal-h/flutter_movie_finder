...
import 'package:movie_finder/features/movie_flow/movie_flow_state.dart';
import 'package:movie_finder/features/movie_flow/movie_service.dart';
...
class MovieFlowController extends StateNotifier<MovieFlowState> {
  ...
  Future<void> loadGenres() async {
    ...
    final result = await _movieService.getGenre();
